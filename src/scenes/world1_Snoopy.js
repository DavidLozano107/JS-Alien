...
class WorldlSnoopy extends Phaser.Scene{
    ...
    preload(){
        ...
        //This is the Player
        this.load.spritesheet("alien2","./assets/Player/PlayerAlien/Alien2/walking/alien2_walking.png",{ frameWidth: 148, frameHeight: 158 });
    }    
    create(){
        alert("dd");
        //Background
        ...
        this.playerG = this.physics.add.sprite(100, 120, 'alien2');
